class User < ApplicationRecord
  ...
  def activate
    # Updates two attributes with with a single call, which hits the database
    # only once.
  ...
  def password_reset_expired?
    # This DOES NOT mean "sent less than two hours ago". It should read as
    # "sent earlier than two hours ago".
